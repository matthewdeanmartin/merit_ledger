...
<!-- TODO (generated from template — delete this block once done)
  ...
  - [ ] Add a PyPI badge: https://badge.fury.io/py/merit_ledger
  - [ ] Add a CI badge from your GitHub Actions build.yml
  - [ ] Fill in docs/overview/README.md with a real project overview
  - [ ] Add real subcommands to merit_ledger/cli.py and update scripts/basic_checks.sh
...
Keep track of your merit. A Chinese Mahayana Buddhist practice from 1000 years ago.

## Installation

```bash
pipx install merit_ledger
```

Or with pip:

```bash
pip install merit_ledger
```
